...
const SeminarManagement = () => {
  ...
  // Create new seminar
  const handleCreate = () => {
    Axios.post("http://localhost:5000/api/seminars", newSeminar,{ withCredentials: true })
      .then((response) => {
        ...
        showToastMessage("New Seminar was added.", "success");
  ...
  const handleUpdate = () => {
    Axios.put(
      `http://localhost:5000/api/seminars/${editSeminar.id}`,
      editSeminar
    )
      .then((response) => {
          ...
          <div className="form-container">
            ...
            <div className="card-body">
              ...
              <input
                ...
                value={
                  editSeminar ? editSeminar.description : newSeminar.description
                }
                onChange={(e) =>
                  editSeminar
                    ? setEditSeminar({
              ...
              <input
                ...
                value={
                  editSeminar
                    ? editSeminar.timeFrame.from
                    : newSeminar.timeFrame.from
                }
                onChange={(e) =>
                  editSeminar
                    ? setEditSeminar({
              ...
              <input
                ...
                value={
                  editSeminar
                    ? editSeminar.timeFrame.to
                    : newSeminar.timeFrame.to
                }
                onChange={(e) =>
                  editSeminar
                    ? setEditSeminar({
              ...
              <input
                ...
                value={
                  editSeminar
                    ? editSeminar.speaker.name
                    : newSeminar.speaker.name
                }
                onChange={(e) =>
                  editSeminar
                    ? setEditSeminar({
              ...
              <input
                ...
                value={
                  editSeminar
                    ? editSeminar.speaker.image
                    : newSeminar.speaker.image
                }
                onChange={(e) =>
                  editSeminar
                    ? setEditSeminar({
              ...
              <input
                ...
                value={
                  editSeminar
                    ? editSeminar.speaker.linkedin
                    : newSeminar.speaker.linkedin
                }
                onChange={(e) =>
                  editSeminar
                    ? setEditSeminar({
              ...
              <input
                ...
                value={
                  editSeminar
                    ? editSeminar.slotsAvailable
                    : newSeminar.slotsAvailable
                }
                onChange={(e) =>
                  editSeminar
                    ? setEditSeminar({
